...
- 기여점
    ...
    ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142424/notion_blog/2026-02-10-llava15-img1.png)
    ...
    - 학술적 task 중심인 vqa 데이터셋, ocr, 지역 레벨 인식을 위한 데이터셋을 추가함
        - instructblip 사용된 4개의 데이터셋을 추가함
            ...
            - ocr 데이터: OCRVQA, TextCaps
                ...
                ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142426/notion_blog/2026-02-10-llava15-img2.png)
...
- 본 연구는 **이미지 분할 및 인코딩** 전략을 제안함
    ...
    ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142427/notion_blog/2026-02-10-llava15-img3.png)
...
![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142429/notion_blog/2026-02-10-llava15-img4.png)


![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142431/notion_blog/2026-02-10-llava15-img5.png)
...
- **global context**
    - 전체 이미지를 패딩하고 224 사이즈로 resize해서 전역 context 피처로 제공함
        ...
        ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142433/notion_blog/2026-02-10-llava15-img6.png)
...
- format instruction generalization
    ...
    - 질문에 사실적 오류가 있는 tricky question, json format으로 응답하라는 요청에도 성공적으로 수행함
        ...
        ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142435/notion_blog/2026-02-10-llava15-img7.png)


        ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142437/notion_blog/2026-02-10-llava15-img8.png)
...
- 두 가지 계열의 llm을 비교함
    ...
    - vicuna 시리즈는 SFT만 함, llama-2-chat은 RLHF까지 적용됨
        ...
        ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142439/notion_blog/2026-02-10-llava15-img9.png)
...
- <u>학습 데이터를 10%에서 50%까지 랜덤 샘플링</u>을 해서, **데이터 양을 줄였을 때 성능이 얼마나 유지되는지** 확인하고자 함
    ...
    ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142441/notion_blog/2026-02-10-llava15-img10.png)
