...
![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142116/notion_blog/2026-04-29-spatialrgpt-img1.png)
...
- 3.1. 3D scene graph from single 2d images
    ...
    ![단일 이미지 → 객체 분리 → depth 복원 → 카메라 보정 → 객체별 3D 박스 생성 → 객체 간 관계 그래프 생성](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142119/notion_blog/2026-04-29-spatialrgpt-img2.png)
...
- 3.2. Learning Spatial-aware VLMs from 3D scene graph
    ...
    ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142122/notion_blog/2026-04-29-spatialrgpt-img3.png)
...
- 3.3. VLM 아키텍쳐
    ...
    ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142125/notion_blog/2026-04-29-spatialrgpt-img4.png)
...
- 4.1.  3D 공간 추론 벤치마크
    ...
    ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142126/notion_blog/2026-04-29-spatialrgpt-img5.png)
...
- 4.2. 일반 vision-language 벤치마크
    - 일반 벤치마크
        ...
        ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142128/notion_blog/2026-04-29-spatialrgpt-img6.png)
    ...
    - Region 및 Spatial 벤치마크
        ...
        ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142130/notion_blog/2026-04-29-spatialrgpt-img7.png)
        ...
        - BLINK의 relative depth 벤치마크에서 평가를 수행
            ...
            - spatialRGPT는 point level 입력으로 학습 x, bbox를 사용해 해당 포인트를 지정해서 평가함
                ...
                ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142132/notion_blog/2026-04-29-spatialrgpt-img8.png)
...
- 4.3. Real-world applications
    - 복잡한 공간 추론
        ...
        ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142134/notion_blog/2026-04-29-spatialrgpt-img9.png)
    ...
    - Multi-hop 추론
        ...
        ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142137/notion_blog/2026-04-29-spatialrgpt-img10.png)
    ...
    - Region-aware dense reward annotator
        ...
        - 손가락이 목표 큐브로 이동할 수록 거리 값이 점진적으로 감소
            ...
            ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142139/notion_blog/2026-04-29-spatialrgpt-img11.png)
