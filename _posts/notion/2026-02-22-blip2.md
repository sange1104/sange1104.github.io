...
- 두 모달리티의 정렬
    ...
    - 본 연구에서는 두 unimodal 모델을 frozen한채로 잘 정렬시키기 위해서, <u>**2단계로 사전학습된 querying trasformer**</u>를 제시함
        ...
        ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142346/notion_blog/2026-02-22-blip2-img1.png)
...
- 기여점
    ...
    ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142348/notion_blog/2026-02-22-blip2-img2.png)
    ...
    **3.3. Bootstrap Vision-to-Language Generative Learning from a Frozen LLM**
    ...
    ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142350/notion_blog/2026-02-22-blip2-img3.png)
    ...
    **3.4. Model Pre-training**
    ...
    ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142352/notion_blog/2026-02-22-blip2-img4.png)
    ...
    **4.1. Instructed Zero-shot Image-to-Text Generation**
    ...
    ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142353/notion_blog/2026-02-22-blip2-img5.png)
    ...
    - Zero-shot VQA
        ...
        ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142355/notion_blog/2026-02-22-blip2-img6.png)
    ...
    - Effect of Vision-Language Representation Learning
        - 1단계 표현학습이 성능에 미치는 영향?
            ...
            ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142357/notion_blog/2026-02-22-blip2-img7.png)
    ...
    **4.2. Image captioning**
    ...
    ![C:CIDEr,S:SPICE,B@4:BLEU@4](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142359/notion_blog/2026-02-22-blip2-img8.png)
    ...
    **4.3. Visual Question Answering**
    ...
    ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142360/notion_blog/2026-02-22-blip2-img9.png)
    ...
    **4.4. Image-Text Retrieval**
    ...
    ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142362/notion_blog/2026-02-22-blip2-img10.png)
    ...
    - 결과
        - zero-shot (flickr30k)에서 기존 방식들을 큰 차이로 이김
            ...
            ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142364/notion_blog/2026-02-22-blip2-img11.png)
