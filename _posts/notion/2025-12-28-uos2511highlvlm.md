...
- LLaVA-NeXT: Improved reasoning, OCR, and world knowledge (2024년 1월)
    - [https://llava-vl.github.io/blog/2024-01-30-llava-next/](https://llava-vl.github.io/blog/2024-01-30-llava-next/)
        ...
        ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142580/notion_blog/2025-12-28-uos2511highlvlm-img1.png)
...
- llava-next의 특징
    ...
    → training efficiency가 특징
        ...
        ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142582/notion_blog/2025-12-28-uos2511highlvlm-img2.png)
...
- 핵심 기술
    1. **AnyRes**
        ...
        3. **Encode & Flatten**: n등분 한 패치들과 축소된 전체 이미지를 각각 인코더에 넣어서 특징을 뽑고, llm에 순서대로 넣음
            ...
            ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142583/notion_blog/2025-12-28-uos2511highlvlm-img3.png)
...
in the Wild (5월 업데이트)
    ...
    - 5월 업데이트에서는 최신 고성능 llm인 llama-3 8b와 qwen1.5 (72b, 110b)를 사용해서 성능을 올림
        ...
        ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142585/notion_blog/2025-12-28-uos2511highlvlm-img4.png)
...
- **Vision FLAN**
    ...
    - 학습 방법
        ...
        ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142587/notion_blog/2025-12-28-uos2511highlvlm-img5.png)
...
- **LLaVA-NeXT**의 ablation study
    - [https://llava-vl.github.io/blog/2024-05-25-llava-next-ablations/](https://llava-vl.github.io/blog/2024-05-25-llava-next-ablations/)
        ...
        ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142589/notion_blog/2025-12-28-uos2511highlvlm-img6.png)
    ...
    - point 4. training pipeline & data quality
        ...
        ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142591/notion_blog/2025-12-28-uos2511highlvlm-img7.png)
...
- **qwen2.5-vl**
    ...
    ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142593/notion_blog/2025-12-28-uos2511highlvlm-img8.png)
...
- **seed1.5-vl**
    - 바이트댄스 모델
        ...
        ![image.png](https://res.cloudinary.com/drsa8npkg/image/upload/v1781142595/notion_blog/2025-12-28-uos2511highlvlm-img9.png)
